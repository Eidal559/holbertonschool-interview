...
This script processes log entries from stdin and computes file sizes and HTTP status code counts.
"""
import sys
...
try:
    ...
    print_stats()
    sys.exit(0)  # Exit cleanly without raising the exception or showing traceback
