...
int *find_substring(char const *s, char const **words, int nb_words, int *n)
{
	...
	*n = 0;
	...
	/* If string shorter than all words concatenated, return NULL */
	...
	{
		/* Create array to mark which words we've found */
		...
		for (int j = 0; j < nb_words && valid; j++)
		{
			...
			/* If chunk doesn't match any word, this substring is invalid */
			if (!word_found)
				valid = 0;
		}
		...
		/* If all words found in this substring, add index to result */
